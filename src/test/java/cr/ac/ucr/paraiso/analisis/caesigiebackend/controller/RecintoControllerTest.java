...
class RecintoControllerTest {
        ...
        void setUp() {
                ...
                recinto = new Recinto(1, "30", "Recinto de Paraiso, Sede del Atlantico", 2511 - 0000, "Cartago",
                                "Paraiso",
                                "Paraiso",
                                "Paraiso de Cartago, del parque de Paraiso, un kilometro y medio carretera a Orosi",

...
class PersonaCoordinadoraControllerTest {
    ...
    void setUp() {
         ...
         personaCoordinadora = new PersonaCoordinadora(1, "Alvaro", "Mena Monge","alvaro@ucr.ac.cr", 88888888,"A0000","1234", consultaActividadesAcademicas );
    ...
    void guardarPersona_InsercionEsCorrecta_InfoPersonaCoordinadora() throws Exception {
        ...
        Mockito.when(service.guardarPersonaCoordinadora(Mockito.any(PersonaCoordinadora.class))).thenReturn(personaCoordinadora);

        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .post("/personacoordinadora")
                .accept(MediaType.APPLICATION_JSON).content("{\"idPersonaCoordinadora\":1,\"nombre\":\"John\",\"apellidos\":\"Doe\",\"correoElectronico\":\"john@ucr.ac.cr\",\"telefono\":12345678,\"carnet\":\"B0000\",\"contrasenna\":\"12345\"}")
    ...
    void findPersonaByEmail_PersonaCoordinadoraExiste_PersonaCoordinadora() throws Exception {
        ...
        PersonaCoordinadora personaCoordinadora = new PersonaCoordinadora(1, "John", "Doe","john@ucr.ac.cr", 12345678,"B0000","12345", consultaActividadesAcademicas );

        Mockito.when(service.findPersonaByEmail(personaCoordinadora.getCorreoElectronico())).thenReturn(personaCoordinadora);
